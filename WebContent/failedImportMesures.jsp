                ...
                <div class="card">
                    ...
                    <div class="content">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="alert alert-danger alert-with-icon" data-notify="container">
									...
									<ul>
										...
										<li>Valeur invalide (ID / Nom / Prenom / Sexe)</li>
										<li>Une case vide</li>
							...
							<div class="col-md-12"><img src="assets/img/templateExcelMesures.png"></div>
							<a href="mesures"><div class="col-md-12"><button class="btn btn-success btn-fill pull-right">Importer un autre fichier</button></div></a>
                        </div>
                        <br>
                        <br>
                    </div>
